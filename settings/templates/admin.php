...
if ($_['databaseOverload']) {
	?>
	<li>
		<strong><?php p($l->t('Database performance info'));?></strong><br>
...
<div id="postsetupchecks">
	...
	<p class="hint hidden">
		<?php print_unescaped($l->t('Please double check the <a href="%s">installation guides</a>, and check for any errors or warnings in the <a href="#log-section">log</a>.', \OC_Helper::linkToDocs('admin-install'))); ?>
	</p>
</div>
</div>
